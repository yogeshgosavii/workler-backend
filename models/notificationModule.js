...
const notificationSchema = new Schema({
  ...
  notificationType: {
    type: String,
    enum: ['application','interview', 'message', 'comment','reply', 'like','follow','approach','mention', 'other'],  // Predefined notification types
    required: true,
  },
  ...
  actionId: { type: Schema.Types.ObjectId, ref: 'Comment' },  // User or event that triggered the notification
}, { timestamps: true });
