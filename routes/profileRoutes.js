...
const router = Router();
import { addSkill, getSkill, updateSkill, deleteSkill, addEducation, getEducation, updateEducation, deleteEducation, addPersonalDetails, getPersonalDetails, updatePersonalDetails, deletePersonalDetails, addProjectDetails, getProjectDetails, updateProjectDetails, deleteProjectDetails, addWorkExperience, getWorkExperience, updateWorkExperience, deleteWorkExperience, addDescription, getDescription, updateDescription, deleteDescription } from '../controllers/profileController.js';
